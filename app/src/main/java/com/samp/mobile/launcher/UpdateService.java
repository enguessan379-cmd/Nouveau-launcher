...
public class UpdateService extends Service {
    ...
    void startUpdating()
    {
        ...
        Volley.newRequestQueue(getApplicationContext()).add(new StringRequest("https://afrorpofficiel.netlify.app/client_config.json", new Response.Listener<String>() {
            @Override
    ...
    public boolean isGameUpdateExists() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d("x1y2z", "isGameUpdateExists -> jeu non installe, installation requise");
            return true;
        }
